 ...
 * 마음 보관함 목록 화면
 */
export default function HeartBoxScreen() {
    ...
    return (
        <SafeAreaView style={styles.container} edges={['top']}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>마음 보관함</Text>
                <TouchableOpacity onPress={() => router.push('/heartbox/create')}>
                    <FontAwesome name="plus" size={20} color={brand.orange} />
                </TouchableOpacity>
            </View>
